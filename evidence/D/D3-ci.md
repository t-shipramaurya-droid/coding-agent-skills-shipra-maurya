...
**Ticket:** PM4-6558  
**Location:** `PM4-6558-assignment/artifacts/D3-ci/`  
**Target:** I4 convert service (`artifacts/I4-convert-pair/service` + client)
...
**Triggers:** push/PR touching `artifacts/I4-convert-pair/**` or workflow file.
...
```bash
cd PM4-6558-assignment/artifacts/D3-ci
