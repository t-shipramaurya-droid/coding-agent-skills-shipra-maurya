...
**Ticket:** PM4-6558  
**Service:** I4 convert (`artifacts/I4-convert-pair/service`)  
**Stack:** `artifacts/D6-observability/` (Prometheus + Grafana compose)
...
| Prometheus + Grafana compose | `artifacts/D6-observability/docker-compose.yml` |
| Load script | `scripts/load-traffic.sh` |
| Dashboard panel JSON | `artifacts/panel-data.json` |
| README run order | `artifacts/D6-observability/README.md` |
