...
**Ticket:** PM4-6558  
**Location:** `PM4-6558-assignment/I4-convert-pair/`  
...
| Two-terminal README | `I4-convert-pair/README.md` |
...
```bash
cd I4-convert-pair/service && .venv/bin/pytest -q
# 7 passed
```
...
```bash
cd I4-convert-pair/client && npm test
# 7 pass
```
